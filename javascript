...
let name="console msg with name"+ name;
console.log(name);
...
* PRIMITIVE DATATYPES :                  * NON-PRIMITIVE DATATYPES :
    ...
    ->undefined
*/
let name="hello"; //string let old version 
let number=20; //integer
let value=undefined; //undefined
value=90; // we can reassign the undefined variables.
let de; //undefined
...
console.log(objectName); //shows all the properties inside obj
//way of accessing object :
//1.USING DOT OPERATOR :
console.log(objectName.number);
//2.USING BRACKET 
console.log(objectName["carname"]);
 ...
 *There are 3 ways to construct array*/
 ...
 let empNmae=["raj","mohan","visal"]; //empty array
 console.log(empNmae);//prints all the elements
 console.log(empNmae[0]);//prints the value for particular element in the specfied index

 //* 2.By creating instance of array(using new keyword)
 let empAge=new Array(5);
 
 //ar[0]="hello";
 console.log(empAge);

 //* 3. Using array constructor : we can create instance of array by passing value as arguments
 let empAge=new Array(3,2,3);
 console.log(empAge);

 //defining arrays :
 //we can define array with mixed data types
 let empDetails=[1,2,'hi'];
 console.log(`mixed array ${empDetails}`);
 //we can also give array inside an array
 let bankAccount=[1,2,3,[4,5]];
 console.log(bankAccount);
 console.log(bankAccount[3]);
 console.log(bankAccount[3][0]); //prints 4
/*ARRAY METHODS:
...
//------------------------------------- DESTRUCTURING -----------------------------//
const studentRollno=[1,2,3,4]
const [firstStud,secondStud]=studentRollno;
console.log(secondStud);

const studentRollno=[1,2,3,4]
const [firstStud,...rest]=studentRollno;
console.log(rest);
...
let empNmae="helloworld";
            //2.Using new keyword
let empName=new String("hello");
console.log("string length = " +empName.length);
//STRING METHODS:
// 1. charAt()
//2. concat()
//3.toUpperCase()
